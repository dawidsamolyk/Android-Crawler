...
public class TopicsAndSettingsFragment extends Fragment {
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		rootView = inflater.inflate(R.layout.fragment_topics_settings,
				container, false);
	...
	private void configureSettingsArea() {
		observeState(R.id.searchAlsoInSubpages,
				CrawlingOption.searchAlsoInSubpages);
		observeState(R.id.contentSearch, CrawlingOption.contentSearch);
		observeState(R.id.requireAllTopicsOnOnePage,
				CrawlingOption.requireAllTopicsOnOnePage);
	}
	...
	private void configureStartButton() {
		...
		startButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(final View v) {
				...
				new CrawlingJob(crawlingOptions, topicsListAdapter
						.getAllTopics());
			}
		});
	}
	...
	private void observeState(final int checkBoxID, final CrawlingOption option) {
		final CheckBox searchAlsoInSubpages = (CheckBox) rootView
				.findViewById(checkBoxID);
		searchAlsoInSubpages
				.setOnCheckedChangeListener(new OnCheckedChangeListener() {
					...
					public void onCheckedChanged(
						...
						TopicsAndSettingsFragment.this.crawlingOptions.put(
								option, isChecked);
					}
				});
	}
