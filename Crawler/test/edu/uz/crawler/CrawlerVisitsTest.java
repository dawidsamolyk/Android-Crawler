...
public class CrawlerVisitsTest {
	...
	public void shouldNotVisitPageWhichIsNotInSameDomainAsCrawlingPage() {
		...
		assertFalse("Strona bêd¹ca w innej domenie nie powinna byæ odwiedzona przez Crawler!", shouldVisit);
	}
	...
	public void shouldNotVisitPageWhichIsNotContainContent() {
		...
		assertFalse("Adres, który nie prowadzi do strony z treœci¹ nie powinien byæ odwiedzony!", shouldVisit);
	}
	...
	public void shouldVisitPageWhichIsInTheSameDomainButWithShortNotation() {
		...
		assertTrue("Strona powinna byæ odwiedzona, poniewa¿ ma tylko krótszy zapis (bez przedrostka www)!", shouldVisit);
	}
	...
	public void shouldVisitMobileWebpageVersion() {
		...
		assertTrue("Strona powinna byæ odwiedzona, poniewa¿ jest jedynie wersj¹ mobiln¹!", shouldVisit);
	}

	public void configureSettings(String webpageAddress) {
		Crawler.SETTINGS = CrawlingSettingsTest.getFixture(webpageAddress, new String[] { "Topic" });
	}
