...
public class CrawlingControllerTest {
	...
	public void shouldNotStopsWhenCrawlerWasNotStarted() throws Exception {
		CrawlingController fixture = new CrawlingController(getFixtureConfiguration(), getFixtureSettings());
	...
	private CrawlingConfiguration getFixtureConfiguration() throws IllegalArgumentException, IOException {
